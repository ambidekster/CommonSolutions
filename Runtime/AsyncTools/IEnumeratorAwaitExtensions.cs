...
using CommonSolutions.Runtime.AsyncTools.Internal;
using UnityEngine;
...
namespace CommonSolutions.Runtime.AsyncTools
{
    public static class IEnumeratorAwaitExtensions
    {
        ...
        {
            return GetAwaiterReturnVoid(instruction, !instruction.keepWaiting);
        }
        ...
        static SimpleCoroutineAwaiter GetAwaiterReturnVoid(object instruction, bool instantCompletion = false)
        {
